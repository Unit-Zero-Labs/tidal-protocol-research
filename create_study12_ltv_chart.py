#!/usr/bin/env python3
"""
Create LTV progression chart for Study 12 optimization iterations
...
def load_test_data():
    """Load all test iteration data from Study 12"""
    test_dir = Path('tidal_protocol_sim/results/Study_12_2022_Bear_Minimum_HF_Daily_Test_Data')
...
def create_ltv_chart(tests):
    ...
    ax.set_title('Study 12: LTV Progression for All Test Iterations\nDaily Rebalancing - 2022 Bear Market',
    ...
    # Save
    output_dir = Path('tidal_protocol_sim/results/Study_12_2022_Bear_Minimum_HF_Daily_Aave_1.19_vs_HT_1.20')
...
def main():
    print("="*80)
    print("Creating LTV Progression Chart for Study 12")
    print("="*80)
    print()
