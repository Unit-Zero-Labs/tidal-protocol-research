#!/usr/bin/env python3
"""
Create LTV progression chart for Study 13 optimization iterations
...
def load_test_data():
    """Load all test iteration data from Study 13"""
    test_dir = Path('tidal_protocol_sim/results/Study_13_2022_Bear_Minimum_HF_Monthly_Test_Data')
...
def create_ltv_chart(tests):
    ...
    ax.set_title('Study 13: LTV Progression for All Test Iterations\nMonthly Rebalancing - 2022 Bear Market',
    ...
    # Save
    output_dir = Path('tidal_protocol_sim/results/Study_13_2022_Bear_Minimum_HF_Monthly_Aave_1.57_vs_HT_1.20')
...
def main():
    print("="*80)
    print("Creating LTV Progression Chart for Study 13 (Monthly)")
    print("="*80)
    print()
