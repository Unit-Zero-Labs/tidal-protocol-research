#!/usr/bin/env python3
"""
Study 11: 2022 Bear Market - Minimum Viable Health Factor (Weekly Rebalancing)

Optimization study to find the absolute minimum health factor that could survive
the 2022 bear market on Aave with weekly rebalancing.
...
class MinimumHFOptimizer:
    ...
    def find_minimum_hf(self) -> Tuple[float, Dict[str, Any]]:
        ...
        print(f"Strategy: Weekly rebalancing with historical Aave rates")
        print("=" * 80)
        print()
...
def run_comparison_with_optimal_hf(optimal_aave_hf: float, optimization_summary: Dict[str, Any]):
    ...
    Both with weekly rebalancing during 2022 bear market.
    """
    print("\n" + "=" * 80)
    ...
    print(f"  - Strategy: Weekly rebalancing")
    ...
    # Study 11 parameters
    config.test_name = f"Study_11_2022_Bear_Minimum_HF_Weekly_Aave_{optimal_aave_hf:.2f}_vs_HT_1.20"
    config.simulation_duration_days = 365
...
def main():
    print("\n" + "🎯" * 40)
    print("STUDY 11: 2022 Bear Market - Minimum Viable Health Factor (Weekly)")
    print("🎯" * 40)
    print()
    print("Objective: Find the absolute minimum health factor that could have")
    print("           survived the 2022 bear market on Aave with weekly rebalancing.")
    print()
    ...
    print("\n" + "=" * 80)
    print("STUDY 11 COMPLETE - KEY FINDINGS")
    print("=" * 80)
    print()
    ...
    print(f"   tidal_protocol_sim/results/Study_11_2022_Bear_Minimum_HF_Weekly_Aave_{optimal_hf:.2f}_vs_HT_1.20/")
    print()
    print("=" * 80)
